...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot (158, 447, 126, 91) action Start()
        hotspot (326, 437, 131, 102) action ShowMenu('load')
        hotspot (490, 434, 124, 105) action ShowMenu('preferences')
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("快读") action QickLoad()
